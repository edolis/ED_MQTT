 ...
 * @build ID: P20250829-221122-5d100c9
 *  @compiledSizeInfo begin

    .iram0.text      85 214    .dram0.data  11 780
    .flash.text     737 398    .dram0.bss   20 344
    .flash.appdesc      256    ―――――――――――――――――――
    .flash.rodata   128 496    total        32 124
    ―――――――――――――――――――――――                       
    subtotal        951 364                       
...
struct GIT_fwInfo {
    ...
    static constexpr const char* BUILD_ID    = "P20250829-221122-5d100c9";
};
} // namespace ED_SYSINFO
// #endregion
// #endregion
...
extern "C" void app_main(void) {
  ...
  WiFiService::subscribeToIPReady([&mqtt_cfg, &MQTTclient]() {
   ...
   MQTTclient = SAMPLE_derivedMqttClient_CRTP::create(mqtt_cfg);
    // ESP_LOGI(TAG, "***MQTTclient is %s", MQTTclient ? "ready" : "not");
    MQTTclient = SAMPLE_derivedMqttClient_CRTP::getInstance();
    // ESP_LOGI(TAG, "***MQTTclient 2 is %s", MQTTclient ? "ready" : "not");
  });
